...
app.post("/api/dna/analyze", authenticateJWT, async (req, res) => {
...
app.post("/api/resume/scan", authenticateJWT, (req, res) => {
...
app.post("/api/jobs/match", authenticateJWT, (req, res) => {
...
app.post("/api/interview/evaluate", authenticateJWT, (req, res) => {
...
app.post("/api/roadmap/generate", authenticateJWT, (req, res) => {
...
app.post("/api/projects/generate", authenticateJWT, (req, res) => {
    const { role } = req.body;
    res.json({
        project: {
...
app.get("/api/recruiter/candidates", authenticateJWT, requireRole(["recruiter", "admin"]), (req, res) => {
    res.json([
